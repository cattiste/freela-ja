  ...
  return (
    <div className="min-h-screen bg-orange-50 p-4">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-lg p-6">
        ...
        {/* Sub-abas (somente para Agenda e Configurações) */}
        ...
        {/* Botão de nova chamada */}
        {chamadaAtiva && (
          <div className="fixed bottom-5 right-5 z-50 animate-bounce">
            <button onClick={() => { setAba('agenda'); setSubAba('agendas') }} className="bg-orange-600 text-white px-4 py-3 rounded-full shadow-lg hover:bg-orange-700">
              🚨 Nova Chamada!
            </button>
          </div>
        )}
