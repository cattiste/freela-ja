          ...
          <div className="max-w-6xl mx-auto p-6">
            <div className="flex justify-between mb-6">
              ...
              <div className="flex gap-2">
                <button onClick={() => navigate('/editar-perfil-freela')} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">✏️ Editar Perfil</button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl shadow p-6">
                <div className="flex items-center gap-6">
                  <img src={freela.foto || 'https://i.imgur.com/3W8i1sT.png'} className="w-24 h-24 rounded-full object-cover border-2 border-blue-400 shadow" alt="Foto do freelancer" />
                  <div>
                  ...
                  <div key={chamada.id} className="border rounded p-3 mb-4">
                    ...
                    {chamada.status === 'pendente' && (
                      <div className="mt-2 flex gap-3">
                        <button onClick={() => updateDoc(doc(db, 'chamadas', chamada.id), { status: 'aceita' })} className="bg-green-600 text-white px-3 py-1 rounded">✅ Aceitar</button>
                        <button onClick={() => updateDoc(doc(db, 'chamadas', chamada.id), { status: 'recusada' })} className="bg-red-600 text-white px-3 py-1 rounded">❌ Recusar</button>
                      </div>
                    )}
                  </div>
                ))}
