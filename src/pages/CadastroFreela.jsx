  ...
  return (
    <div className="max-w-md mx-auto mt-12 p-6 bg-white rounded-xl shadow-lg">
      ...
      <form onSubmit={handleCadastro} className="flex flex-col gap-4">
        ...
        <input type="text" placeholder="Celular" value={celular} onChange={e => setCelular(e.target.value)} className="input-field" required />
        ...
        <input type="number" placeholder="Valor da Diária (R$)" value={valorDiaria} onChange={e => setValorDiaria(e.target.value)} className="input-field" required />
