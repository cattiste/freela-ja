...
export default function ProfissionalCard({ profissional: prof }) {
  return (
    <div className="bg-white shadow-md rounded-xl p-4 text-center hover:scale-105 transition duration-300">
      <img
        src={prof.imagem}
        alt={prof.nome}
