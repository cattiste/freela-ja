...
const botoes = [
  ...
  { id: 'ativas', label: 'Ativas', icon: <Signal size={20} /> },
  { id: 'agendas', label: 'Agendas', icon: <CalendarDays size={20} /> },
  { id: 'vagas', label: 'Serviços', icon: <Briefcase size={20} /> },
  { id: 'avaliacao', label: 'Avaliar', icon: <Star size={20} /> },
  { id: 'historico', label: 'Histórico', icon: <ScrollText size={20} /> }
]

export default function MenuInferiorPessoaFisica({ onSelect, abaAtiva }) {
  return (
